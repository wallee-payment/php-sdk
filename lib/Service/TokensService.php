...
class TokensService
{
     ...
     */
    public function patchPaymentTokensId(int $id, int $space, \Wallee\Sdk\Model\TokenUpdate $token_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentTokensId'][0])
    {
     ...
     */
    public function patchPaymentTokensIdWithHttpInfo(int $id, int $space, \Wallee\Sdk\Model\TokenUpdate $token_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentTokensId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchPaymentTokensIdRequest(int $id, int $space, \Wallee\Sdk\Model\TokenUpdate $token_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentTokensId'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\Token|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postPaymentTokens(int $space, \Wallee\Sdk\Model\TokenCreate $token_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTokens'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\Token|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPaymentTokensWithHttpInfo(int $space, \Wallee\Sdk\Model\TokenCreate $token_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTokens'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentTokensRequest(int $space, \Wallee\Sdk\Model\TokenCreate $token_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTokens'][0])
    {
