...
class PaymentTerminalsService
{
     ...
     */
    public function patchPaymentTerminalsId(int $id, int $space, \Wallee\Sdk\Model\PaymentTerminalUpdate $payment_terminal_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentTerminalsId'][0])
    {
     ...
     */
    public function patchPaymentTerminalsIdWithHttpInfo(int $id, int $space, \Wallee\Sdk\Model\PaymentTerminalUpdate $payment_terminal_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentTerminalsId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchPaymentTerminalsIdRequest(int $id, int $space, \Wallee\Sdk\Model\PaymentTerminalUpdate $payment_terminal_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentTerminalsId'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\PaymentTerminal|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postPaymentTerminals(int $space, \Wallee\Sdk\Model\PaymentTerminalCreate $payment_terminal_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTerminals'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\PaymentTerminal|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPaymentTerminalsWithHttpInfo(int $space, \Wallee\Sdk\Model\PaymentTerminalCreate $payment_terminal_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTerminals'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentTerminalsRequest(int $space, \Wallee\Sdk\Model\PaymentTerminalCreate $payment_terminal_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTerminals'][0])
    {
