...
class CustomersService
{
     ...
     */
    public function patchCustomersId(int $id, int $space, \Wallee\Sdk\Model\CustomerActive $customer_active, ?array $expand = null, string $contentType = self::contentTypes['patchCustomersId'][0])
    {
     ...
     */
    public function patchCustomersIdWithHttpInfo(int $id, int $space, \Wallee\Sdk\Model\CustomerActive $customer_active, ?array $expand = null, string $contentType = self::contentTypes['patchCustomersId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchCustomersIdRequest(int $id, int $space, \Wallee\Sdk\Model\CustomerActive $customer_active, ?array $expand = null, string $contentType = self::contentTypes['patchCustomersId'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\Customer|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postCustomers(int $space, \Wallee\Sdk\Model\CustomerCreate $customer_create, ?array $expand = null, string $contentType = self::contentTypes['postCustomers'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\Customer|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postCustomersWithHttpInfo(int $space, \Wallee\Sdk\Model\CustomerCreate $customer_create, ?array $expand = null, string $contentType = self::contentTypes['postCustomers'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postCustomersRequest(int $space, \Wallee\Sdk\Model\CustomerCreate $customer_create, ?array $expand = null, string $contentType = self::contentTypes['postCustomers'][0])
    {
