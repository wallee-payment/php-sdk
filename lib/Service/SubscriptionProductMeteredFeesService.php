...
class SubscriptionProductMeteredFeesService
{
     ...
     */
    public function patchSubscriptionsProductsMeteredFeesId(int $id, int $space, \Wallee\Sdk\Model\ProductMeteredFeeUpdate $product_metered_fee_update, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsMeteredFeesId'][0])
    {
     ...
     */
    public function patchSubscriptionsProductsMeteredFeesIdWithHttpInfo(int $id, int $space, \Wallee\Sdk\Model\ProductMeteredFeeUpdate $product_metered_fee_update, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsMeteredFeesId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchSubscriptionsProductsMeteredFeesIdRequest(int $id, int $space, \Wallee\Sdk\Model\ProductMeteredFeeUpdate $product_metered_fee_update, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsMeteredFeesId'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\ProductMeteredFee|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postSubscriptionsProductsMeteredFees(int $space, \Wallee\Sdk\Model\ProductMeteredFeeUpdate $product_metered_fee_update, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsMeteredFees'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\ProductMeteredFee|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postSubscriptionsProductsMeteredFeesWithHttpInfo(int $space, \Wallee\Sdk\Model\ProductMeteredFeeUpdate $product_metered_fee_update, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsMeteredFees'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postSubscriptionsProductsMeteredFeesRequest(int $space, \Wallee\Sdk\Model\ProductMeteredFeeUpdate $product_metered_fee_update, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsMeteredFees'][0])
    {
