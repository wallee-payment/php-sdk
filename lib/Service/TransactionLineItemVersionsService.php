...
class TransactionLineItemVersionsService
{
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wallee\Sdk\Model\LineItemVersionListResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    public function getPaymentTransactionsLineItemVersionsSearchWithHttpInfo(int $space, ?array $expand = null, ?int $limit = null, ?int $offset = null, ?string $order = null, ?string $query = null, string $contentType = self::contentTypes['getPaymentTransactionsLineItemVersionsSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wallee\Sdk\Model\LineItemVersionSearchResponse',
                        $request,
                        $response,
                    );
                case 400:
     ...
     *
     * @param int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param \Wallee\Sdk\Model\TransactionLineItemVersionCreate $transaction_line_item_version_create transaction_line_item_version_create (required)
     * @param string[]|null $expand expand (optional)
     ...
     */
    public function postPaymentTransactionsLineItemVersions(int $space, \Wallee\Sdk\Model\TransactionLineItemVersionCreate $transaction_line_item_version_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsLineItemVersions'][0])
    {
     ...
     */
    public function postPaymentTransactionsLineItemVersionsWithHttpInfo(int $space, \Wallee\Sdk\Model\TransactionLineItemVersionCreate $transaction_line_item_version_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsLineItemVersions'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentTransactionsLineItemVersionsRequest(int $space, \Wallee\Sdk\Model\TransactionLineItemVersionCreate $transaction_line_item_version_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsLineItemVersions'][0])
    {
