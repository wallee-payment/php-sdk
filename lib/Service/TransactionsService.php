...
class TransactionsService
{
     ...
     *
     * @param int $id id (required)
     * @param string $format The format specifies how the receipts will be presented in the response. See {@see \Wallee\Sdk\Model\TerminalReceiptFormat}. (required)
     ...
     */
    public function patchPaymentTransactionsId(int $id, int $space, \Wallee\Sdk\Model\TransactionPending $transaction_pending, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentTransactionsId'][0])
    {
     ...
     */
    public function patchPaymentTransactionsIdWithHttpInfo(int $id, int $space, \Wallee\Sdk\Model\TransactionPending $transaction_pending, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentTransactionsId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchPaymentTransactionsIdRequest(int $id, int $space, \Wallee\Sdk\Model\TransactionPending $transaction_pending, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentTransactionsId'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\Transaction|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postPaymentTransactions(int $space, \Wallee\Sdk\Model\TransactionCreate $transaction_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactions'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\Transaction|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPaymentTransactionsWithHttpInfo(int $space, \Wallee\Sdk\Model\TransactionCreate $transaction_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactions'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentTransactionsRequest(int $space, \Wallee\Sdk\Model\TransactionCreate $transaction_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactions'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\TransactionCompletion|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postPaymentTransactionsIdCompletePartiallyOffline(int $id, int $space, \Wallee\Sdk\Model\TransactionCompletionDetails $transaction_completion_details, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsIdCompletePartiallyOffline'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\TransactionCompletion|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPaymentTransactionsIdCompletePartiallyOfflineWithHttpInfo(int $id, int $space, \Wallee\Sdk\Model\TransactionCompletionDetails $transaction_completion_details, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsIdCompletePartiallyOffline'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentTransactionsIdCompletePartiallyOfflineRequest(int $id, int $space, \Wallee\Sdk\Model\TransactionCompletionDetails $transaction_completion_details, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsIdCompletePartiallyOffline'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\TransactionCompletion|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postPaymentTransactionsIdCompletePartiallyOnline(int $id, int $space, \Wallee\Sdk\Model\TransactionCompletionDetails $transaction_completion_details, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsIdCompletePartiallyOnline'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\TransactionCompletion|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPaymentTransactionsIdCompletePartiallyOnlineWithHttpInfo(int $id, int $space, \Wallee\Sdk\Model\TransactionCompletionDetails $transaction_completion_details, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsIdCompletePartiallyOnline'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentTransactionsIdCompletePartiallyOnlineRequest(int $id, int $space, \Wallee\Sdk\Model\TransactionCompletionDetails $transaction_completion_details, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsIdCompletePartiallyOnline'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\Transaction|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postPaymentTransactionsIdConfirm(int $id, int $space, \Wallee\Sdk\Model\TransactionPending $transaction_pending, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsIdConfirm'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\Transaction|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPaymentTransactionsIdConfirmWithHttpInfo(int $id, int $space, \Wallee\Sdk\Model\TransactionPending $transaction_pending, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsIdConfirm'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentTransactionsIdConfirmRequest(int $id, int $space, \Wallee\Sdk\Model\TransactionPending $transaction_pending, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsIdConfirm'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\Transaction|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postPaymentTransactionsIdProcessCardDetails(int $id, int $space, \Wallee\Sdk\Model\AuthenticatedCardRequest $authenticated_card_request, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsIdProcessCardDetails'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\Transaction|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPaymentTransactionsIdProcessCardDetailsWithHttpInfo(int $id, int $space, \Wallee\Sdk\Model\AuthenticatedCardRequest $authenticated_card_request, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsIdProcessCardDetails'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentTransactionsIdProcessCardDetailsRequest(int $id, int $space, \Wallee\Sdk\Model\AuthenticatedCardRequest $authenticated_card_request, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsIdProcessCardDetails'][0])
    {
     ...
     * @return string|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postPaymentTransactionsIdProcessCardDetailsThreed(int $id, int $space, \Wallee\Sdk\Model\TokenizedCardRequest $tokenized_card_request, string $contentType = self::contentTypes['postPaymentTransactionsIdProcessCardDetailsThreed'][0])
    {
     ...
     * @return array of string|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPaymentTransactionsIdProcessCardDetailsThreedWithHttpInfo(int $id, int $space, \Wallee\Sdk\Model\TokenizedCardRequest $tokenized_card_request, string $contentType = self::contentTypes['postPaymentTransactionsIdProcessCardDetailsThreed'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentTransactionsIdProcessCardDetailsThreedRequest(int $id, int $space, \Wallee\Sdk\Model\TokenizedCardRequest $tokenized_card_request, string $contentType = self::contentTypes['postPaymentTransactionsIdProcessCardDetailsThreed'][0])
    {
