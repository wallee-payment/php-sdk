...
class SubscriptionProductSetupFeesService
{
     ...
     */
    public function patchSubscriptionsProductsSetupFeesId(int $id, int $space, \Wallee\Sdk\Model\ProductSetupFeeUpdate $product_setup_fee_update, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsSetupFeesId'][0])
    {
     ...
     */
    public function patchSubscriptionsProductsSetupFeesIdWithHttpInfo(int $id, int $space, \Wallee\Sdk\Model\ProductSetupFeeUpdate $product_setup_fee_update, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsSetupFeesId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchSubscriptionsProductsSetupFeesIdRequest(int $id, int $space, \Wallee\Sdk\Model\ProductSetupFeeUpdate $product_setup_fee_update, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsSetupFeesId'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\ProductSetupFee|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postSubscriptionsProductsSetupFees(int $space, \Wallee\Sdk\Model\ProductSetupFeeUpdate $product_setup_fee_update, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsSetupFees'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\ProductSetupFee|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postSubscriptionsProductsSetupFeesWithHttpInfo(int $space, \Wallee\Sdk\Model\ProductSetupFeeUpdate $product_setup_fee_update, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsSetupFees'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postSubscriptionsProductsSetupFeesRequest(int $space, \Wallee\Sdk\Model\ProductSetupFeeUpdate $product_setup_fee_update, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsSetupFees'][0])
    {
