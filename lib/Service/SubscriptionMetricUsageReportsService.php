...
class SubscriptionMetricUsageReportsService
{
     ...
     */
    public function postSubscriptionsMetricUsageReports(int $space, \Wallee\Sdk\Model\SubscriptionMetricUsageReportCreate $subscription_metric_usage_report_create, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsMetricUsageReports'][0])
    {
     ...
     */
    public function postSubscriptionsMetricUsageReportsWithHttpInfo(int $space, \Wallee\Sdk\Model\SubscriptionMetricUsageReportCreate $subscription_metric_usage_report_create, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsMetricUsageReports'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postSubscriptionsMetricUsageReportsRequest(int $space, \Wallee\Sdk\Model\SubscriptionMetricUsageReportCreate $subscription_metric_usage_report_create, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsMetricUsageReports'][0])
    {
