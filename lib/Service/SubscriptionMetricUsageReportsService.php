...
class SubscriptionMetricUsageReportsService
{
    ...
    public function getSubscriptionsMetricUsageReportsWithHttpInfo($space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getSubscriptionsMetricUsageReports'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wallee\Sdk\Model\MetricUsageReportListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wallee\Sdk\Model\MetricUsageReportListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Wallee\Sdk\Model\MetricUsageReportListResponse', []),
            ...
            $returnType = '\Wallee\Sdk\Model\MetricUsageReportListResponse';
    ...
    public function getSubscriptionsMetricUsageReportsIdWithHttpInfo($id, $space, $expand = null, string $contentType = self::contentTypes['getSubscriptionsMetricUsageReportsId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wallee\Sdk\Model\SubscriptionMetricUsageReport' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wallee\Sdk\Model\SubscriptionMetricUsageReport' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Wallee\Sdk\Model\SubscriptionMetricUsageReport', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Wallee\Sdk\Model\SubscriptionMetricUsageReport';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    public function getSubscriptionsMetricUsageReportsSearchWithHttpInfo($space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getSubscriptionsMetricUsageReportsSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wallee\Sdk\Model\MetricUsageReportSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wallee\Sdk\Model\MetricUsageReportSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Wallee\Sdk\Model\MetricUsageReportSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Wallee\Sdk\Model\MetricUsageReportSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
