...
class SubscriptionProductMeteredFeeTiersService
{
     ...
     */
    public function patchSubscriptionsProductsMeteredFeesFeeIdTiersId(int $fee_id, int $id, int $space, \Wallee\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsMeteredFeesFeeIdTiersId'][0])
    {
     ...
     */
    public function patchSubscriptionsProductsMeteredFeesFeeIdTiersIdWithHttpInfo(int $fee_id, int $id, int $space, \Wallee\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsMeteredFeesFeeIdTiersId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchSubscriptionsProductsMeteredFeesFeeIdTiersIdRequest(int $fee_id, int $id, int $space, \Wallee\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsMeteredFeesFeeIdTiersId'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\ProductMeteredTierFee|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postSubscriptionsProductsMeteredFeesFeeIdTiers(int $fee_id, int $space, \Wallee\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsMeteredFeesFeeIdTiers'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\ProductMeteredTierFee|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postSubscriptionsProductsMeteredFeesFeeIdTiersWithHttpInfo(int $fee_id, int $space, \Wallee\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsMeteredFeesFeeIdTiers'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postSubscriptionsProductsMeteredFeesFeeIdTiersRequest(int $fee_id, int $space, \Wallee\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsMeteredFeesFeeIdTiers'][0])
    {
