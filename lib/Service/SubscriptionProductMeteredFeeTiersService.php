...
class SubscriptionProductMeteredFeeTiersService
{
    ...
    public function getSubscriptionsProductsMeteredFeesFeeIdTiersWithHttpInfo($fee_id, $space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getSubscriptionsProductsMeteredFeesFeeIdTiers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wallee\Sdk\Model\ProductMeteredFeeTierListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wallee\Sdk\Model\ProductMeteredFeeTierListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Wallee\Sdk\Model\ProductMeteredFeeTierListResponse', []),
            ...
            $returnType = '\Wallee\Sdk\Model\ProductMeteredFeeTierListResponse';
    ...
    public function getSubscriptionsProductsMeteredFeesFeeIdTiersIdWithHttpInfo($fee_id, $id, $space, $expand = null, string $contentType = self::contentTypes['getSubscriptionsProductsMeteredFeesFeeIdTiersId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wallee\Sdk\Model\ProductMeteredTierFee' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wallee\Sdk\Model\ProductMeteredTierFee' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Wallee\Sdk\Model\ProductMeteredTierFee', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Wallee\Sdk\Model\ProductMeteredTierFee';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    public function getSubscriptionsProductsMeteredFeesFeeIdTiersSearchWithHttpInfo($fee_id, $space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getSubscriptionsProductsMeteredFeesFeeIdTiersSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wallee\Sdk\Model\ProductMeteredFeeTierSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wallee\Sdk\Model\ProductMeteredFeeTierSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Wallee\Sdk\Model\ProductMeteredFeeTierSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Wallee\Sdk\Model\ProductMeteredFeeTierSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
