...
class SubscriptionProductVersionsService
{
     ...
     */
    public function patchSubscriptionsProductsVersionsId(int $id, int $space, \Wallee\Sdk\Model\SubscriptionProductVersionPending $subscription_product_version_pending, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsVersionsId'][0])
    {
     ...
     */
    public function patchSubscriptionsProductsVersionsIdWithHttpInfo(int $id, int $space, \Wallee\Sdk\Model\SubscriptionProductVersionPending $subscription_product_version_pending, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsVersionsId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchSubscriptionsProductsVersionsIdRequest(int $id, int $space, \Wallee\Sdk\Model\SubscriptionProductVersionPending $subscription_product_version_pending, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsVersionsId'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\SubscriptionProductVersion|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postSubscriptionsProductsVersions(int $space, \Wallee\Sdk\Model\SubscriptionProductVersionPending $subscription_product_version_pending, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsVersions'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\SubscriptionProductVersion|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postSubscriptionsProductsVersionsWithHttpInfo(int $space, \Wallee\Sdk\Model\SubscriptionProductVersionPending $subscription_product_version_pending, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsVersions'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postSubscriptionsProductsVersionsRequest(int $space, \Wallee\Sdk\Model\SubscriptionProductVersionPending $subscription_product_version_pending, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsVersions'][0])
    {
     ...
     */
    public function postSubscriptionsProductsVersionsIdRetire(int $id, int $space, \Wallee\Sdk\Model\SubscriptionProductVersionRetirementRequest $subscription_product_version_retirement_request, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsVersionsIdRetire'][0])
    {
     ...
     */
    public function postSubscriptionsProductsVersionsIdRetireWithHttpInfo(int $id, int $space, \Wallee\Sdk\Model\SubscriptionProductVersionRetirementRequest $subscription_product_version_retirement_request, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsVersionsIdRetire'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postSubscriptionsProductsVersionsIdRetireRequest(int $id, int $space, \Wallee\Sdk\Model\SubscriptionProductVersionRetirementRequest $subscription_product_version_retirement_request, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsVersionsIdRetire'][0])
    {
