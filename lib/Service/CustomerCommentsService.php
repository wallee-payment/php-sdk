...
class CustomerCommentsService
{
     ...
     */
    public function patchCustomersCustomerIdCommentsId(int $customer_id, int $id, int $space, \Wallee\Sdk\Model\CustomerCommentActive $customer_comment_active, ?array $expand = null, string $contentType = self::contentTypes['patchCustomersCustomerIdCommentsId'][0])
    {
     ...
     */
    public function patchCustomersCustomerIdCommentsIdWithHttpInfo(int $customer_id, int $id, int $space, \Wallee\Sdk\Model\CustomerCommentActive $customer_comment_active, ?array $expand = null, string $contentType = self::contentTypes['patchCustomersCustomerIdCommentsId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchCustomersCustomerIdCommentsIdRequest(int $customer_id, int $id, int $space, \Wallee\Sdk\Model\CustomerCommentActive $customer_comment_active, ?array $expand = null, string $contentType = self::contentTypes['patchCustomersCustomerIdCommentsId'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\CustomerComment|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postCustomersCustomerIdComments(int $customer_id, int $space, \Wallee\Sdk\Model\CustomerCommentCreate $customer_comment_create, ?array $expand = null, string $contentType = self::contentTypes['postCustomersCustomerIdComments'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\CustomerComment|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postCustomersCustomerIdCommentsWithHttpInfo(int $customer_id, int $space, \Wallee\Sdk\Model\CustomerCommentCreate $customer_comment_create, ?array $expand = null, string $contentType = self::contentTypes['postCustomersCustomerIdComments'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postCustomersCustomerIdCommentsRequest(int $customer_id, int $space, \Wallee\Sdk\Model\CustomerCommentCreate $customer_comment_create, ?array $expand = null, string $contentType = self::contentTypes['postCustomersCustomerIdComments'][0])
    {
