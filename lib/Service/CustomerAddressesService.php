...
class CustomerAddressesService
{
     ...
     */
    public function patchCustomersCustomerIdAddressesId(int $customer_id, int $id, int $space, \Wallee\Sdk\Model\CustomerAddressActive $customer_address_active, ?array $expand = null, string $contentType = self::contentTypes['patchCustomersCustomerIdAddressesId'][0])
    {
     ...
     */
    public function patchCustomersCustomerIdAddressesIdWithHttpInfo(int $customer_id, int $id, int $space, \Wallee\Sdk\Model\CustomerAddressActive $customer_address_active, ?array $expand = null, string $contentType = self::contentTypes['patchCustomersCustomerIdAddressesId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchCustomersCustomerIdAddressesIdRequest(int $customer_id, int $id, int $space, \Wallee\Sdk\Model\CustomerAddressActive $customer_address_active, ?array $expand = null, string $contentType = self::contentTypes['patchCustomersCustomerIdAddressesId'][0])
    {
     ...
     * @return \Wallee\Sdk\Model\CustomerAddress|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse
     */
    public function postCustomersCustomerIdAddresses(int $customer_id, int $space, \Wallee\Sdk\Model\CustomerAddressCreate $customer_address_create, ?array $expand = null, string $contentType = self::contentTypes['postCustomersCustomerIdAddresses'][0])
    {
     ...
     * @return array of \Wallee\Sdk\Model\CustomerAddress|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse|\Wallee\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postCustomersCustomerIdAddressesWithHttpInfo(int $customer_id, int $space, \Wallee\Sdk\Model\CustomerAddressCreate $customer_address_create, ?array $expand = null, string $contentType = self::contentTypes['postCustomersCustomerIdAddresses'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postCustomersCustomerIdAddressesRequest(int $customer_id, int $space, \Wallee\Sdk\Model\CustomerAddressCreate $customer_address_create, ?array $expand = null, string $contentType = self::contentTypes['postCustomersCustomerIdAddresses'][0])
    {
