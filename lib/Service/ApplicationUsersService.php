...
class ApplicationUsersService
{
     ...
     */
    public function patchApplicationUsersId(int $id, \Wallee\Sdk\Model\ApplicationUserUpdate $application_user_update, ?array $expand = null, string $contentType = self::contentTypes['patchApplicationUsersId'][0])
    {
     ...
     */
    public function patchApplicationUsersIdWithHttpInfo(int $id, \Wallee\Sdk\Model\ApplicationUserUpdate $application_user_update, ?array $expand = null, string $contentType = self::contentTypes['patchApplicationUsersId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchApplicationUsersIdRequest(int $id, \Wallee\Sdk\Model\ApplicationUserUpdate $application_user_update, ?array $expand = null, string $contentType = self::contentTypes['patchApplicationUsersId'][0])
    {
     ...
     */
    public function postApplicationUsers(\Wallee\Sdk\Model\ApplicationUserCreate $application_user_create, ?array $expand = null, string $contentType = self::contentTypes['postApplicationUsers'][0])
    {
     ...
     */
    public function postApplicationUsersWithHttpInfo(\Wallee\Sdk\Model\ApplicationUserCreate $application_user_create, ?array $expand = null, string $contentType = self::contentTypes['postApplicationUsers'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postApplicationUsersRequest(\Wallee\Sdk\Model\ApplicationUserCreate $application_user_create, ?array $expand = null, string $contentType = self::contentTypes['postApplicationUsers'][0])
    {
