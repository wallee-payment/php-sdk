...
class InvoiceReconciliationRecordService {
	 ...
	 * @return void
	 */
	public function linkTransaction($space_id, $id, $invoice_id, $amount = null) {
		return $this->linkTransactionWithHttpInfo($space_id, $id, $invoice_id, $amount)->getData();
	}

	/**
	 * Operation linkTransactionWithHttpInfo
	 *
	 * Link transaction
	 *
	 * @param int $space_id  (required)
	 ...
	 * @return ApiResponse
	 */
	public function linkTransactionWithHttpInfo($space_id, $id, $invoice_id, $amount = null) {
		// verify the required parameter 'space_id' is set
		if (is_null($space_id)) {
			throw new \InvalidArgumentException('Missing the required parameter $space_id when calling linkTransaction');
		}
		// verify the required parameter 'id' is set
		if (is_null($id)) {
			throw new \InvalidArgumentException('Missing the required parameter $id when calling linkTransaction');
		}
		// verify the required parameter 'invoice_id' is set
		if (is_null($invoice_id)) {
			throw new \InvalidArgumentException('Missing the required parameter $invoice_id when calling linkTransaction');
		}
		// header params
		$headerParams = [];
		$headerAccept = $this->apiClient->selectHeaderAccept([]);
		...
		// path params
		$resourcePath = '/invoice-reconciliation-record-service/link-transaction';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$headerParams,
				null,
				'/invoice-reconciliation-record-service/link-transaction'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders());
		} catch (ApiException $e) {
			switch ($e->getCode()) {
	 ...
	 * @return void
	 */
	public function unlinkTransaction($space_id, $id, $linked_completion_id) {
		return $this->unlinkTransactionWithHttpInfo($space_id, $id, $linked_completion_id)->getData();
	}
	 ...
	 * @return ApiResponse
	 */
	public function unlinkTransactionWithHttpInfo($space_id, $id, $linked_completion_id) {
		// verify the required parameter 'space_id' is set
		if (is_null($space_id)) {
		...
		// verify the required parameter 'id' is set
		if (is_null($id)) {
			throw new \InvalidArgumentException('Missing the required parameter $id when calling unlinkTransaction');
		}
		// verify the required parameter 'linked_completion_id' is set
		if (is_null($linked_completion_id)) {
			throw new \InvalidArgumentException('Missing the required parameter $linked_completion_id when calling unlinkTransaction');
		}
		// header params
		$headerParams = [];
		$headerAccept = $this->apiClient->selectHeaderAccept([]);
		...
		if (!is_null($linked_completion_id)) {
			$queryParams['linkedCompletionId'] = $this->apiClient->getSerializer()->toQueryValue($linked_completion_id);
		}

		// path params
		$resourcePath = '/invoice-reconciliation-record-service/unlink-transaction';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$headerParams,
				null,
				'/invoice-reconciliation-record-service/unlink-transaction'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders());
		} catch (ApiException $e) {
			switch ($e->getCode()) {
