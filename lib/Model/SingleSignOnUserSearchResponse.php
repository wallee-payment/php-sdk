...
class SingleSignOnUserSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\SingleSignOnUser[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\SingleSignOnUser[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\SingleSignOnUser[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
