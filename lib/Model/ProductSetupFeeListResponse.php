...
class ProductSetupFeeListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\ProductSetupFee[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\ProductSetupFee[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\ProductSetupFee[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
