...
class ManualTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'type' => 'int',
        'actions' => '\Wallee\Sdk\Model\ManualTaskAction[]',
        'created_on' => '\DateTime'
    ];
    ...
    */
     ...
     * Gets state
     *
     * @return \Wallee\Sdk\Model\ManualTaskState|null
     */
     ...
     * Sets state
     *
     * @param \Wallee\Sdk\Model\ManualTaskState|null $state state
     *
     * @return self
     */
     ...
     * Gets actions
     *
     * @return \Wallee\Sdk\Model\ManualTaskAction[]|null
     */
     ...
     * Sets actions
     *
     * @param \Wallee\Sdk\Model\ManualTaskAction[]|null $actions The actions that can be triggered to handle the manual task.
     *
     * @return self
     */
