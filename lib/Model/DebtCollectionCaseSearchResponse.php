...
/**
 * DebtCollectionCaseSearchResponse model
 *
 * @category    Class
 * @package     Wallee\Sdk
 * @author      wallee AG
 ...
 */
class DebtCollectionCaseSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Debt_Collection_Case_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\DebtCollectionCase[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\DebtCollectionCase[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\DebtCollectionCase[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
