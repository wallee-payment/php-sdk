...
/**
 * DebtCollectorConfigurationSearchResponse model
 *
 * @category    Class
 * @package     Wallee\Sdk
 * @author      wallee AG
 ...
 */
class DebtCollectorConfigurationSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Debt_Collector_Configuration_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\DebtCollectorConfiguration[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\DebtCollectorConfiguration[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
