...
/**
 * DebtCollectorSearchResponse model
 *
 * @category    Class
 * @package     Wallee\Sdk
 * @author      wallee AG
 ...
 */
class DebtCollectorSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Debt_Collector_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\DebtCollector[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\DebtCollector[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
