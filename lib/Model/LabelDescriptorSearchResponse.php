...
class LabelDescriptorSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\LabelDescriptor[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\LabelDescriptor[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\LabelDescriptor[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
