 ...
 */
class DebtCollectionCaseCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DebtCollectionCase.Create';
    ...
    */
     ...
     *
     * @param int|null $collector_configuration The configuration that the case is processed with.
     *
     * @return self
     */
