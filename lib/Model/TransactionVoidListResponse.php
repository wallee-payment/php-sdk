...
class TransactionVoidListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\TransactionVoid[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\TransactionVoid[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\TransactionVoid[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
