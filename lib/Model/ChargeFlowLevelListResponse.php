...
class ChargeFlowLevelListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\ChargeFlowLevel[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\ChargeFlowLevel[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\ChargeFlowLevel[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
