...
class DunningCaseSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\DunningCase[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\DunningCase[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\DunningCase[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
