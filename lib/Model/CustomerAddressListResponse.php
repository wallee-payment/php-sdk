...
class CustomerAddressListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\CustomerAddress[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\CustomerAddress[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\CustomerAddress[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
