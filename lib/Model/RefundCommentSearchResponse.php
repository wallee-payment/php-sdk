...
class RefundCommentSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\RefundComment[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\RefundComment[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\RefundComment[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
