...
class UserAccountRoleListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\UserAccountRole[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\UserAccountRole[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\UserAccountRole[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
