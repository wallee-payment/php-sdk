...
class PaymentLinkListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\PaymentLink[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\PaymentLink[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\PaymentLink[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
