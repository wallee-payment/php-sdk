...
class LineItemVersionSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\TransactionLineItemVersion[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\TransactionLineItemVersion[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
