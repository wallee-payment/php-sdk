...
class ExternalTransferBankTransactionListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\ExternalTransferBankTransaction[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\ExternalTransferBankTransaction[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\ExternalTransferBankTransaction[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
