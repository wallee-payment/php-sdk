...
class StaticValueListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\StaticValue[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\StaticValue[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\StaticValue[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
