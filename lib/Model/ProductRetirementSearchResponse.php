...
class ProductRetirementSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\SubscriptionProductRetirement[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\SubscriptionProductRetirement[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\SubscriptionProductRetirement[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
