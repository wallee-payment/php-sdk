...
class AuthenticatedCardDataCreate implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Wallee\Sdk\Model\CardholderAuthenticationCreate $cardholder_authentication Optional authentication details for the cardholder, such as 3D Secure authentication, used when the cardholder has already been verified during the transaction for added security.
     *
     * @return $this
     */
