...
class DunningFlowLevelSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\DunningFlowLevel[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\DunningFlowLevel[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\DunningFlowLevel[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
