...
class SuspensionSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\SubscriptionSuspension[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\SubscriptionSuspension[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\SubscriptionSuspension[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
