...
/**
 * AbstractShopifySubscriptionProductActive model
 *
 * @category    Class
 * @package     Wallee\Sdk
 ...
 */
class AbstractShopifySubscriptionProductActive implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Abstract.ShopifySubscriptionProduct.Active';
