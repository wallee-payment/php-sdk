 ...
 */
class DebtCollectionCaseDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DebtCollectionCaseDocument';
    ...
    */
     ...
     * Sets file_name
     *
     * @param string|null $file_name The file name of the document.
     *
     * @return self
     */
     ...
     * Sets mime_type
     *
     * @param string|null $mime_type The MIME type of the document's content.
     *
     * @return self
     */
     ...
     * Sets unique_id
     *
     * @param string|null $unique_id A unique identifier of the document.
     *
     * @return self
     */
