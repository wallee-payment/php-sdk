...
class CurrencyListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\RestCurrency[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\RestCurrency[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\RestCurrency[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
