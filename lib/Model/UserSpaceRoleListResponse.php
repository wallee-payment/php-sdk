...
class UserSpaceRoleListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Wallee\Sdk\Model\UserSpaceRole[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Wallee\Sdk\Model\UserSpaceRole[]|null
     */
     ...
     * Sets data
     *
     * @param \Wallee\Sdk\Model\UserSpaceRole[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
